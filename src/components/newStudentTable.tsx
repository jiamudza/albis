...
const NewStudentsTable = ({ data, pageData, filter }: { data: any[], pageData: DataCount, filter: (value:string) => void}) => {
    ...
    return (
        <div>
            ...
            {pageData && pageData.dataLength === 0 ? <div className='bg-background text-sm font-semibold text-center py-2'>Data tidak ditemukan</div> : <TableList key="student" columns={columns} renderRow={renderNewStudent} data={data} />}
            </div>
