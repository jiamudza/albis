...
const Search = () => {
  return (
    <div
      className="hidden bg-opacity-30 border-accent md:flex items-center justify-start gap-2 rounded-full border border-b-4 bg-white px-1 py-1 text-xs shadow-lg shadow-gray-300/50 backdrop-blur-md"
      style={{
